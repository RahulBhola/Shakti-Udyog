...
function FileCard({ fileName, sizeBytes, dragIdx, dragFileIndex, onDragStart, onDragOver, onDrop, onDragEnd, onDelete, src, localUrl, isServerFile }: {
  fileName: string; sizeBytes: number; dragIdx: number;
    ...
    <div className="space-y-6 pb-8">
      ...
      <form id="edit-form" onSubmit={handleSubmit} className="space-y-5">
        ...
        <Section title="5. Attachments">
          ...
          {/* Upload new files */}
          <div className={`mt-4 flex flex-col items-center justify-center py-8 px-6 rounded-xl border-2 border-dashed cursor-pointer transition-all ${
