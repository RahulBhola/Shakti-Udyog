    ...
    <>
      ...
      <Panel title="Order details">
        {invoice.items.length === 0 ? (
          <p className="placeholder-note">No line items on this invoice.</p>
        ) : (
          <div className="table-scroll">
            <table className="data-table">
              <thead>
                <tr>
                  <th>Description</th><th>HSN</th><th>Qty</th><th>Unit</th>
      ...
      {invoice.bank && (
        <Panel title="Pay to (bank details)">
          <div className="table-scroll">
            <table className="data-table">
              <tbody>
                <tr><th scope="row">Account holder</th><td>{invoice.bank.accountHolderName}</td></tr>
                <tr><th scope="row">Bank name</th><td>{invoice.bank.bankName}</td></tr>
                <tr><th scope="row">Account number</th><td>{invoice.bank.accountNumber}</td></tr>
                <tr><th scope="row">IFSC code</th><td>{invoice.bank.ifscCode}</td></tr>
              </tbody>
            </table>
          </div>
          <p className="placeholder-note">Transfer the amount above and upload the payment proof to confirm your payment.</p>
        </Panel>
      )}
    </>
  );
