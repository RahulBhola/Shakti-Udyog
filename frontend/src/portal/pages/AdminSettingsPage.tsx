...
import {
  Building2, Percent, Package, Bell, ShieldCheck, Plug, Flag, Landmark,
...
const SECTIONS: SectionDef[] = [
  ...
  {
    id: "bank", title: "Bank Account (shown on Bills)", description: "Seller bank details customers see on every invoice so they know where to pay.",
    icon: Landmark,
    fields: [
      { key: "bank.bankName", label: "Bank Name", type: "text", placeholder: "e.g. HDFC Bank" },
      { key: "bank.accountHolder", label: "Account Holder Name", type: "text", placeholder: "Shakti Udyog" },
      { key: "bank.accountNumber", label: "Account Number", type: "text", placeholder: "XXXX-XXXX-XXXX" },
      { key: "bank.ifscCode", label: "IFSC Code", type: "text", placeholder: "XXXX0000000" },
    ],
  },
  {
