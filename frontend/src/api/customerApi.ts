...
export interface QuotationDetail extends QuotationListItem {
  ...
  items: QuotationItem[];
  /** Present once the quotation has been accepted and an invoice ("bill") was generated. */
  invoiceId: string | null;
  /** "Unpaid" | "Partially Paid" | "Paid" — drives Pay Now visibility. */
  paymentStatus: string | null;
  /** Latest payment status on the generated invoice:
      null | "Pending Verification" | "Verified" | "Rejected". */
...
/** Seller's bank account shown on the bill so the customer knows where to pay. */
