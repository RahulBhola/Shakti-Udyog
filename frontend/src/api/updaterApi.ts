...
export const updaterApi = {
  ...
  createShipment: (id: string, transporter?: string, trackingNumber?: string, vehicleNumber?: string, phoneNumber?: string, dispatchDateUtc?: string, estimatedArrivalUtc?: string) =>
    apiPost<{ message: string }>(`${base}/orders/${id}/shipment`, { transporter, trackingNumber, vehicleNumber, phoneNumber, dispatchDateUtc, estimatedArrivalUtc }),
  updateShipment: (orderId: string, shipmentId: string, transporter?: string, trackingNumber?: string, vehicleNumber?: string, phoneNumber?: string, dispatchDateUtc?: string, estimatedArrivalUtc?: string) =>
    apiPatch<{ message: string }>(`${base}/orders/${orderId}/shipments/${shipmentId}`, { transporter, trackingNumber, vehicleNumber, phoneNumber, dispatchDateUtc, estimatedArrivalUtc }),
