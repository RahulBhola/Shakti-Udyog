...
export const adminApi = {
  ...
  productMaster: {
    ...
    delete: (id: string) => apiDelete<{ message: string }>(`${base}/product-master/${id}`),
    archive: (id: string) => apiPost<{ message: string }>(`${base}/product-master/${id}/archive`),
    restore: (id: string) => apiPost<{ message: string }>(`${base}/product-master/${id}/restore`),
