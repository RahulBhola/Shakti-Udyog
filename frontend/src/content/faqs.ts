/** FAQs per requirements §23. Bracketed items are pending verification. */
export const faqs = [
  {
  ...
  },
  {
    ...
    answer:
      "Yes. We review customer drawings, models, samples, and application needs to assess the casting route, pattern requirement, material, and production feasibility.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "We supply grades according to our approved manufacturing capability and the customer's applicable specification. Share your required grade and standard with the enquiry.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Minimum order quantity depends on the casting size, process, pattern requirement, and production planning. Contact us with your part details for guidance.",
  },
] as const;
