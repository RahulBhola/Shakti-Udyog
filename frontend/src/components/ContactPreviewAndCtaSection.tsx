          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 items-center">
            ...
            <div className="lg:col-span-6">
              <div className={`relative rounded-2xl overflow-hidden border transition-all ${
                isLight ? 'border-neutral-200 bg-[#0d131f]' : 'border-blue-900/40 bg-[#070a12]'
                ...
                <div className="absolute inset-0 opacity-80 pointer-events-none">
                  <svg className="w-full h-full" viewBox="0 0 600 450" fill="none" xmlns="http://www.w3.org/2000/svg">
                    {/* Background Grids */}
                    <path d="M0 100 H600 M0 200 H600 M0 300 H600 M0 400 H600" stroke="#162032" strokeWidth="1" />
                    <path d="M100 0 V450 M200 0 V450 M300 0 V450 M400 0 V450 M500 0 V450" stroke="#162032" strokeWidth="1" />

                    {/* Major Highways & Arteries */}
                    <path d="M-20 400 L250 150 L580 40" stroke="#2a3952" strokeWidth="8" strokeLinecap="round" />
                    <path d="M-20 400 L250 150 L580 40" stroke="#1e2c42" strokeWidth="6" strokeLinecap="round" />
                    
                    {/* NH-44 Route */}
                    <path d="M150 450 L320 200 L480 -20" stroke="#374b6b" strokeWidth="10" />
                    <path d="M150 450 L320 200 L480 -20" stroke="#25354e" strokeWidth="8" />

                    {/* Daba Road Connecting Artery */}
                    <path d="M220 280 L440 100" stroke="#3b82f6" strokeWidth="3.5" strokeDasharray="6 4" />
                    
                    {/* Secondary Roads */}
                    <path d="M50 80 L350 380" stroke="#1c283b" strokeWidth="4" />
                    <path d="M380 420 L580 200" stroke="#1c283b" strokeWidth="4" />
                    <path d="M50 300 L550 250" stroke="#1f2d42" strokeWidth="3" />

                    {/* Landmark Labels */}
                    <text x="360" y="80" fill="#64748b" fontSize="11" fontFamily="monospace">Sherpur Chowk</text>
                    <text x="470" y="120" fill="#64748b" fontSize="10" fontFamily="monospace">Model Town</text>
                    <text x="510" y="170" fill="#475569" fontSize="9" fontFamily="monospace">HAIBOWAL KALAN</text>
                    <text x="355" y="90" fill="#94a3b8" fontSize="11" fontWeight="bold" fontFamily="sans-serif">SPS Hospital Ⓗ</text>
                    <text x="300" y="140" fill="#60a5fa" fontSize="12" fontWeight="bold" fontFamily="sans-serif">Daba Road</text>
                    <text x="370" y="175" fill="#475569" fontSize="10" fontFamily="monospace">NH 44</text>
                    <text x="305" y="140" fill="#475569" fontSize="9" fontFamily="monospace">BABA DEEP SINGH NAGAR</text>
                  </svg>
                </div>
                ...
                <div className="relative z-10 bg-[#090d16]/90 border border-blue-900/50 backdrop-blur-md p-4 rounded-xl flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 shadow-xl">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      <div className="text-sm font-bold text-white tracking-tight">Shakti Udyog</div>
                  ...
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-1.5 px-4 py-2 rounded-full border border-blue-500/40 text-blue-400 hover:bg-blue-500/10 text-xs font-semibold shrink-0 transition-colors"
                  >
