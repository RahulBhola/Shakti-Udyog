...
public static class OrderStatuses
{
    ...
    public static readonly IReadOnlyDictionary<string, IReadOnlySet<string>> ValidTransitions =
        new Dictionary<string, IReadOnlySet<string>>
        {
            ...
            [AdvancePaid] = new HashSet<string> { Confirmed, PatternDevelopment, Production, QualityCheck, Packed, ReadyToDispatch, OnHold, Cancelled },
            [Confirmed] = new HashSet<string> { PatternDevelopment, Production, QualityCheck, Packed, ReadyToDispatch, OnHold, Cancelled },
            [PatternDevelopment] = new HashSet<string> { Production, QualityCheck, Packed, ReadyToDispatch, OnHold, Cancelled },
            [Production] = new HashSet<string> { PatternDevelopment, QualityCheck, Packed, ReadyToDispatch, OnHold, Cancelled },
            [QualityCheck] = new HashSet<string> { PatternDevelopment, Production, Packed, ReadyToDispatch, OnHold, Cancelled },
            [Packed] = new HashSet<string> { PatternDevelopment, Production, QualityCheck, ReadyToDispatch, OnHold, Cancelled },
            [ReadyToDispatch] = new HashSet<string> { PatternDevelopment, Production, QualityCheck, Packed, Dispatched, OnHold, Cancelled },
            [Dispatched] = new HashSet<string> { ReadyToDispatch, Delivered, Cancelled },
