...
public static class InvoiceStatuses
{
    ...
    public static readonly IReadOnlyList<string> All =
        [Draft, Issued, PartiallyPaid, Paid, FullyPaid, Overdue, Cancelled, CreditNoteIssued];
}
...
/// <summary>Customer-facing state of the payment-proof workflow (drives the Pay Now button).</summary>
public static class PaymentProofStatuses
{
    ...
    public static readonly IReadOnlyList<string> All = [Pending, Uploaded, Verified, Rejected];
}
