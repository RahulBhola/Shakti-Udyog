...
public DbSet<KanbanTask> KanbanTasks => Set<KanbanTask>();
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        builder.Entity<EmailOtp>(entity =>
        {
            ...
            entity.Property(o => o.CodeHash).HasMaxLength(88).IsRequired();
            entity.Property(o => o.CreatedByIp).HasMaxLength(64);
            entity.HasIndex(o => o.CodeHash).IsUnique();
        ...
        builder.Entity<Quotation>(entity =>
        {
            ...
            entity.Property(q => q.DeliveryTime).HasMaxLength(500);
            entity.Property(q => q.Warranty).HasMaxLength(500);
        ...
        builder.Entity<Order>(entity =>
        {
            ...
            entity.Property(o => o.AdvanceAmount).HasPrecision(18, 2);
            entity.Property(o => o.QuotationTotal).HasPrecision(18, 2);
            ...
            entity.HasIndex(o => o.AssignedEngineerId);
            ...
            entity.HasOne(o => o.AssignedEngineer).WithMany()
                .HasForeignKey(o => o.AssignedEngineerId).OnDelete(DeleteBehavior.SetNull);
        });
        ...
        builder.Entity<Rfq>(entity =>
        {
            ...
            entity.Property(r => r.ApproxWeight).HasPrecision(18, 2);
        ...
        builder.Entity<ProductionStageHistory>(entity =>
        {
            ...
            entity.HasQueryFilter(h => !h.Job.IsDeleted);
        });
        ...
        builder.Entity<ProductionQuality>(entity =>
        {
            ...
            entity.HasQueryFilter(q => !q.Job.IsDeleted);
        });
        ...
        builder.Entity<ProductionComment>(entity =>
        {
            ...
            entity.HasQueryFilter(c => !c.Job.IsDeleted);
        });
        ...
        builder.Entity<ProductionTimeline>(entity =>
        {
            ...
            entity.HasQueryFilter(t => !t.Job.IsDeleted);
        });
