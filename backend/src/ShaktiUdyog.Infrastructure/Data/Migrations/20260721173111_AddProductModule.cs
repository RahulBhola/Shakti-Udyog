        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                    Description = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    ExampleComponents = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TypicalApplications = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: true),
                    CommonGrades = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    CastingWeightRange = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: true),
                    AvailableFinish = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    MaterialGrades = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductMedias_StorageKey",
                table: "ProductMedias",
                column: "StorageKey",
                unique: true);
