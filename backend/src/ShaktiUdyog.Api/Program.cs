...
var authBuilder = builder.Services
    ...
    .AddJwtBearer(options =>
    {
        ...
        // SignalR client sends the JWT as an `access_token` query parameter for
        // hub connections. Accept it only for the hub path.
...
builder.Services.AddSingleton<IInvoicePdfService, PlaceholderInvoicePdfService>();
...
builder.Services.AddSingleton<IPortalPush, PortalPushService>();
