...
public record QuotationDetailDto(
    ...
    Guid? InvoiceId = null, string? PaymentStatus = null, string? PaymentProofStatus = null);
...
public record OrderCommercialDto(
    ...
    string? PaymentProofStatus = null, Guid? InvoiceId = null);
...
/// <summary>Seller's bank account shown on the bill so the customer knows where to pay.</summary>
public record BankAccountDto(
    string BankName, string AccountNumber, string IfscCode, string AccountHolderName);
...
public record PaymentDto(
    ...
    Guid? ProofDocumentId = null, string? VerificationNote = null);
